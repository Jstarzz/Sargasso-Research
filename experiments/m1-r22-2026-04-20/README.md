# Model 1 R22: Positive-patch threshold reduced to 0.002

**Date:** 2026-04-20 · **Status:** COMPLETED · **Outcome:** positive

Positive-patch threshold reduced to 0.002. Historical disposition: kept.

| Metric | Value | Scope |
|---|---:|---|
| validation_iou | 0.087 | Historical validation split; guarded labels only for R48/R49 |

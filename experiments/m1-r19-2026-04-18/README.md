# Model 1 R19: Random resized crop

**Date:** 2026-04-18 · **Status:** COMPLETED · **Outcome:** negative

Random resized crop. Historical disposition: reverted.

| Metric | Value | Scope |
|---|---:|---|
| validation_iou | 0.069 | Historical validation split; guarded labels only for R48/R49 |

# Model 1 R34: Weighted sampling

**Date:** 2026-04-23 · **Status:** COMPLETED · **Outcome:** negative

Weighted sampling. Historical disposition: discard.

| Metric | Value | Scope |
|---|---:|---|
| validation_iou | 0.0637 | Historical validation split; guarded labels only for R48/R49 |

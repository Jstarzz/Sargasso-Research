# Model 1 R17: Learning rate reduced to 5e-5

**Date:** 2026-04-19 · **Status:** COMPLETED · **Outcome:** negative

Learning rate reduced to 5e-5. Historical disposition: reverted.

| Metric | Value | Scope |
|---|---:|---|
| validation_iou | 0.0638 | Historical validation split; guarded labels only for R48/R49 |

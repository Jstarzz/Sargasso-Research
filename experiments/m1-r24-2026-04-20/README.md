# Model 1 R24: Dropout on expanded 60-epoch baseline

**Date:** 2026-04-20 · **Status:** COMPLETED · **Outcome:** negative

Dropout on expanded 60-epoch baseline. Historical disposition: discard.

| Metric | Value | Scope |
|---|---:|---|
| validation_iou | 0.0945 | Historical validation split; guarded labels only for R48/R49 |
